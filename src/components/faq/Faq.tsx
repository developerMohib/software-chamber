...
const Faq = () => {
    return (
        <section className='py-10 px-14 bg-white'>
            <div>
                <h1 className="font-bricolage text-5xl font-medium text-[#0C0C0C] text-center mx-auto leading-14">Comprehensive Answers to the Most <br />
            ...
            <div className={`${styles.dashedSpaced} flex items-center justify-between my-8 pb-10`}>
                <h1 className='text-4xl text-black font-semibold font-bricolage'>FAQ</h1>

...
const Faq = () => {
    return (
        <section className='py-10 md:px-14 p-5 bg-white'>
            <div>
                <h1 className="font-bricolage md:text-5xl text-3xl font-medium text-[#0C0C0C] text-center mx-auto md:leading-14">Comprehensive Answers to the Most <span className="hidden md:inline"><br /></span>

...
const Footer = () => {
    return (
        <footer className="mt-10 px-10">
            <div>
                <h1 className='uppercase font-bricolageGrotesque text-6xl text-white' >Let&apos;s talk</h1>
            </div>
            <div className="py-10 text-gray-800 sm:flex justify-between mx-auto">
                <div className="py-5 sm:w-4/12">
                    <p className="text-[#A6A6A6] text-sm mb-5">A new era of energy, elegance, and elite competition begins here. Where passion meets performance on the court like never before.</p>
                    <h1 className='font-bricolageGrotesque text-xl text-white px-2' >Let&apos;s talk</h1>
            ...
            -0.416,-0.385l-0.519,0l0,-1.426l4.847,0l1.583,5.704l0.042,0l1.598,-5.704l5.021,0l0,1.426Z" />
                ...
                <div className="p-5 sm:w-5/12 flex flex-col">
                    ...
                    <div className="flex mb-3">
                        <div className="h-20 w-3/12 bg-cover" style={{ backgroundImage: 'url("https://tailwindcss.com/img/card-left.jpg")' }} title="Woman holding a mug">
                        </div>
                ...
                <div className="p-5 sm:w-3/12">
                    ...
                    <ul className="grid grid-cols-2 gap-5">
                        <li>
                            <Image src="https://images.pexels.com/photos/174938/pexels-photo-174938.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" className="w-100" alt='' width={500} height={500} />
                        </li>
                        <li>
                            <Image src="https://images.pexels.com/photos/174938/pexels-photo-174938.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" className="w-100" alt='' width={500} height={500} />
                        </li>

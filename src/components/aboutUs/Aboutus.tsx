...
const Aboutus = () => {
    return (
        <section className="bg-white p-10">
            <div>
                <h1 className="text-center text-[#0C0C0C] font-semibold font-bricolageGrotesque text-5xl md:w-4/5 mx-auto"><span className='inline-block align-middle font-bold mr-1.5'>
